...
\chapter*{Übungsblatt 2}
	...
	\begin{enumerate}
		\item Z.z. $ \forall n \in N $
		\begin{itemize}
			\item Induktionsanfang:
			\begin{flalign*}
			\sum^{n}_{k=1} \frac{1}{k(k+1)} & = 1 - \frac{1}{n+1} & \\
			n = 1: ~~  \frac{1}{1(1+1)} = 1 - \frac{1}{1+1} & \Leftrightarrow \frac{1}{2} = \frac{1}{2} & \\
			n = 2: ~~  \frac{1}{2(2+1)} = 1 - \frac{1}{2+1} & \Leftrightarrow \frac{2}{3} = \frac{2}{3} & 
			\end{flalign*}
			\item Induktionsvoraussetzung:
			\begin{flalign*}
			\sum^{n}_{k=1} \frac{1}{k(k+1)} & = 1 - \frac{1}{(n+1)}
		...
		\end{flalign*}
	\end{enumerate}	
	\section{Übungsblatt2, Aufgabe 2: Kombinatorik, 4 Punkte, \GruppeA}
	\section{Übungsblatt2, Aufgabe 3: Konvergenz von Reihen, 4 Punkte, \GruppeA}
	\section{Übungsblatt2, Aufgabe 4: , 4 Punkte, \GruppeA}
