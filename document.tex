...
\chapter*{Übungsblatt 2}
	...
	\begin{enumerate}
		...
		\end{flalign*}
		Der Dividend ist wegen der Quadratur nie negativ für alle $x,y > 0 ~\in R$, auch für $ y > x $. Damit ist die rechte Seite nie negativ und stets $\geq 0 $.\par
		b)\par
	...
	\begin{enumerate}
		...
		\begin{flalign*}
			...
			b.) & \frac{x+y}{1+\abs{x+y}} \leq \frac{\abs{x}}{1+\abs{x}} + \frac{\abs{y}}{1+\abs{y}ß} , \text{für alle } x,y \in R
		\end{flalign*}
	\end{enumerate}
